...
class PathomicsFeaturesBase(object):
    ...
    def mask2bounds(self, fname,                    # fname是单通道numpy数组mask，fname_intensity是三通道numpy数组patch
        ...
        mask = fname.astype(bool) if ifbinarization else fname  # 确保将单通道numpy数组mask转换成单通道布尔类型mask。.astype一看就是numpy的用法
